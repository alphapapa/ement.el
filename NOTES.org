...
*** TODO Column in room list for room type
...
*** TODO Show invited rooms in rooms list

*** TODO Store =invite_state= for invited rooms
...
*** TODO Set footer of invited rooms to a clickable link to join the room
